    ...
    <div>
      ...
      {step === 1 ? (
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-[16px] font-medium sm:text-[20px]">Фото:</h3>
                ...
                dinoToChange?.images.map((image) => (
                  <div
                    ...
                    <Image
                      ...
                      height={800}
                      alt="dino image"
                      className="w-56 h-60 object-fit border-2 border-brightOrange"
                    />
                    <button
                      type="button"
            ...
            <div className="flex flex-wrap gap-4">
              {dinoToChange && dinoToChange?.foundLocations.length === 0 ? (
                ...
                dinoToChange?.foundLocations.map((loc) => (
                  <div
                    key={loc.id}
                    className="group relative flex flex-col gap-1 bg-slateGray text-white py-2 px-5">
                    <button
                      type="button"
                      ...
                      onClick={(e) => onHandleDeleteFoundLocation(e, loc.id)}>
                      Видалити
                    </button>
                    <span>Широта: {Number(loc.latitude).toFixed(1)}</span>
                    <span>Довгота: {Number(loc.longitude).toFixed(1)}</span>
