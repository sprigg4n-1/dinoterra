...
const AuthStartPage = () => {
  ...
  return (
    <section className="h-screen text-white flex flex-col items-center justify-center gap-10 bg-auth-bg bg-bottom bg-cover bg-no-repeat relative after:absolute after:w-full after:h-full after:bg-black after:bg-opacity-85 after:backdrop-blur-[2px]">
      ...
      <Link
        ...
        href="/"
      >
        {t("buttonText.loginWithoutSignUp")}
      </Link>
    </section>
  );
};
